...
//!
//! These errors describe violated persistence boundaries: decoding fails as
//! corruption, encoding fails on format limits, and catalog operations reject
//! invalid persistent identity or visibility state. Aggregation into the public
//! [`crate::Error`] happens in the parent module.

use crate::catalog::{ManifestEncodeError, ManifestParseError, StoreFileParseError};

...
//!
//! The format layer owns the representation needed to encode sorted records.
//! Callers can store entries however they want as long as they expose stable
//! borrowed key/value slices through `EntrySource`.

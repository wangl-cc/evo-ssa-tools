...
/// Converts a length or offset into the persisted `u32` envelope.
pub(crate) fn format_u32(value: usize, quantity: &'static str) -> Result<u32, crate::FormatError> {
    u32::try_from(value).map_err(|_| crate::FormatError::limit(quantity))
}

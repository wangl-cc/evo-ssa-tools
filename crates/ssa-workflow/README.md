...
Allowed id characters are ASCII letters, digits, `.`, and `-`. The separator `--` is reserved internally. Prefer lowercase kebab-case and bump the version when the meaning of a result changes.

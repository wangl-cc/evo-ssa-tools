...
- `RedbStore::new(database, table_name) -> storage::Result<RedbStore>` where `table_name` accepts either `&'static str` or `String`; opening eagerly creates the table if needed
